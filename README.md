...
Local MCP portfolio analysis driven by Claude Desktop or Claude Code, with optional Wealthsimple integration for full portfolio awareness. Exposes 84 MCP tools and 21 analysis skills covering risk, earnings, macro, dividends, tax, technicals, and quant anomalies. Backed by 12 swappable market-data adapters behind a shared interface.
...
> **Disclaimer.** Outcomes are LLM-generated and may be wrong. Not financial advice; verify before acting.
...
- **MCP integrators** wanting a real reference: 84 typed tools, circuit-breaker fallback across 12 data adapters, response-layer PII filtering, 21-skill prompt-template harness.
