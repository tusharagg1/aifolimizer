...
**Available Cash:** $8,500 CAD
**Framework:** Add-to-winners with crowding guard
...
| Available cash | **$8,500 CAD** |
| Cash as % of NLV | 4.2% |
| Target deploy this round | $7,500 (keep ~$1,000 dry powder) |
| Min position add | $1,500 |

---

## Top 3 Add-to Candidates

| # | Ticker | Current Weight | Target Weight | Suggested $ | Conviction | Crowding | Flag |
|---|--------|----------------|----------------|-------------|------------|----------|------|
| 1 | **CSU.TO** | 4.1% | 6.0% | $3,000 | HIGH | 42 (neutral) | Add |
...
| Ticker | Crowding | Setup | Why now |
|--------|----------|-------|---------|
| **MG.TO** (Magna Intl) | 22 (contrarian) | RSI 38, basing above SMA200 | Auto cyclical, dividend support, FCF inflection Q3 |
| **FFH.TO** (Fairfax) | 28 (contrarian) | Breakout above $2,100 | Insurance hard market, BV growth 15% YoY, low analyst coverage |

**Action:** add to watchlist; run `/adversarial-research <ticker>` before any entry.
...
| Action | BUY |
| Quantity | 1 share |
| Entry (limit) | $4,180.00 |
| Stop loss | $3,860.00 (-7.7%) |
| Target | $4,720.00 (+12.9%) |
| Risk/Reward | 1.68 |
| Max loss | $320 |
...
| Action | ADD |
| Quantity | 12 shares |
| Entry (limit) | $208.50 USD |
| Stop loss | $194.00 (-7.0%) |
| Target | $232.00 (+11.3%) |
| Risk/Reward | 1.62 |
| Max loss | ~$235 CAD |
| Order type | LIMIT, GTC |
...
- Deploying **$7,500 of $8,500 available** across 3 names.
- 1 high-quality holding (NVDA) **skipped** due to crowding >= 70.
- 2 contrarian watchlist names flagged for further research.
- Reserve **$1,000** as dry powder for opportunistic adds on weakness.
