...
## Portfolio Snapshot
**NLV:** $145,200 CAD  &nbsp;&nbsp;|&nbsp;&nbsp; **1d:** +0.82% (+$1,184)  &nbsp;&nbsp;|&nbsp;&nbsp; **Cash:** $6,420 CAD (4.4%)

| Account | Value (CAD) | 1d % |
|---|---:|---:|
| TFSA | $78,400 | +0.91% |
| RRSP | $52,100 | +0.74% |
| Non-Reg | $9,260 | +0.68% |
...
## Macro Snapshot (FRED, as of 2026-06-01)

| Indicator | Latest | 30d Δ |
|---|---:|---:|
| Fed Funds Rate | 4.25% | -25 bps |
| US 10Y Yield | 4.08% | -12 bps |
| CAD/USD | 0.738 | +0.6% |
| BoC Overnight Rate | 3.00% | unch |
| US CPI YoY | 2.7% | -0.1 pp |

Read: easing cycle continues, USD softening modestly vs CAD. Disinflation on track but not yet at target.
...
|---|---|---|---|---:|
| 2026-06-04 | AAPL | AMC | yes | $1.62 |
| 2026-06-07 | NVDA | AMC | yes | $0.91 |
| 2026-06-10 | SHOP.TO | BMO | yes | $0.34 |
| 2026-06-12 | COST | AMC | no (watchlist) | $4.18 |
...
| Ticker | Weight | Value (CAD) | 1d % | YTD % |
|---|---:|---:|---:|---:|
| NVDA | 12.4% | $18,005 | +2.1% | +38.2% |
| XEQT | 11.8% | $17,134 | +0.5% | +9.4% |
| VFV | 9.7% | $14,084 | +0.6% | +11.1% |

Other notable: AAPL (8.2%), SHOP.TO (5.1%), CASH.TO (3.9%).

---

*Educational, not advice. Verify before acting.*
