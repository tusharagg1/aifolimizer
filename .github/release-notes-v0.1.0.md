...
- **80 MCP tools** exposed via FastMCP, organized by service (Wealthsimple session, market data, fundamentals, technicals, news, macro, quant, portfolio analytics, health score, crypto data, alerts, recommendations).
