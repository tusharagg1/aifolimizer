...
TSX_UNIVERSE = [
    "XEQT.TO", "VFV.TO", "XIU.TO", "XIC.TO", "ZEB.TO", "ZRE.TO",
    "TD.TO", "RY.TO", "BNS.TO", "BMO.TO", "CM.TO", "NA.TO",
    "CNR.TO", "CP.TO", "TRP.TO", "ENB.TO", "SU.TO", "CVE.TO",
    "ATD.TO", "MFC.TO", "SLF.TO", "GWO.TO", "POW.TO",
    "SHOP.TO", "CSU.TO", "KXS.TO", "OTEX.TO", "BB.TO",
    "WPM.TO", "ABX.TO", "K.TO", "AEM.TO",
    "L.TO", "MRU.TO", "EMP-A.TO",
    "BCE.TO", "T.TO", "TELUS.TO",
]

SPX_UNIVERSE = [
    "AAPL", "MSFT", "NVDA", "AMZN", "GOOGL", "META", "TSLA", "AVGO",
    "JPM", "V", "MA", "UNH", "HD", "PG", "JNJ", "MRK", "ABBV",
    "XOM", "CVX", "COP", "WMT", "COST", "TGT",
    "AMD", "QCOM", "AMAT", "KLAC", "LRCX",
    "LLY", "TMO", "DHR", "ABT",
    "CAT", "DE", "HON", "RTX", "LMT",
    "BRK-B", "BAC", "WFC", "GS", "MS",
    "SPY", "QQQ", "IWM", "GLD", "TLT",
